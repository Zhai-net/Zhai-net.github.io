  ...
  function renderPiFeature() {
    ...
    target.innerHTML = `
      <div class="pi-card-top">
        <img alt="${escapeHTML(pi.imageAlt || `${pi.name}照片`)}" class="pi-photo" data-lightbox="" decoding="async" fetchpriority="low" loading="lazy" src="${escapeHTML(pi.image || 'assets/portraits/portrait-placeholder.jpg')}"/>
